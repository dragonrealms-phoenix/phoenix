For compatibility with the larger DragonRealms community,
...
of what can be done in Genie config files is supported. For example,
Phoenix does not support setting variables or running scripts.
However, Phoenix seamlessly integrates with Lich for script support.
