...
import { getExperienceMindState } from '../game.utils';

describe('game-utils', () => {
  describe('#getExperienceMindStateValue', () => {
    it('should return the correct value for the given mind state', () => {
    ...
    it('should return undefined if the given mind state is invalid', () => {
